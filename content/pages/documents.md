      ...
      - type: FeaturedItem
        ...
        actions:
          - type: Button
            ...
            icon: arrowRight
            url: >-
              https://docs.google.com/spreadsheets/d/15RQ6F5PRQqIFBHWgQ2fVb2d1LelHNzxEgeyro2rH1Yw/edit?gid=46925013#gid=46925013
            style: secondary
        styles:
          self:
            textAlign: left
    ...
    items:
      ...
      - type: FeaturedItem
        ...
        actions:
          - label: View
            altText: ''
            url: /files/Exec_Meeting_01-27-2025.pdf
            showIcon: true
            icon: arrowRight
            iconPosition: right
            style: primary
      ...
      - type: FeaturedItem
        ...
        actions:
          - label: View
            altText: ''
            url: /files/Exec_Meeting_01-13-2025.pdf
            showIcon: true
            icon: arrowRight
            iconPosition: right
            style: primary
      ...
      - type: FeaturedItem
        ...
        actions:
          - label: View
            altText: ''
            url: /files/Exec_Meeting_11-23-2024.pdf
            showIcon: true
            icon: arrowRight
            iconPosition: right
            style: primary
      ...
      - type: FeaturedItem
        ...
        actions:
          - label: View
            altText: ''
            url: /files/Exec_Meeting_11-09-2024.pdf
            showIcon: true
            icon: arrowRight
            iconPosition: right
            style: primary
